...
import com.ruoyi.hitch.domain.Test;
import com.ruoyi.hitch.service.ITestService;
 ...
 */
@Controller
@RequestMapping("/hitch/test")
public class TestController extends BaseController
{
    private String prefix = "hitch/test";

    @Autowired
    private ITestService testService;

    @RequiresPermissions("hitch:test:view")
    @GetMapping()
    public String test()
    {
        return prefix + "/test";
     ...
     * 查询测试列表
     */
    @RequiresPermissions("hitch:test:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出测试列表
     */
    @RequiresPermissions("hitch:test:export")
     ...
     * 新增保存测试
     */
    @RequiresPermissions("hitch:test:add")
     ...
     * 修改测试
     */
    @RequiresPermissions("hitch:test:edit")
    @GetMapping("/edit/{id}")
     ...
     * 删除测试
     */
    @RequiresPermissions("hitch:test:remove")
